...
3. Copy and paste the following code into the *R script editor*, then click *Run*. (Note that you may need to first install the *forecast* package in your local R environment using *install.packages("forecast")* ). After a few seconds, you should see a plot display on the report.  
```R
library(forecast)
